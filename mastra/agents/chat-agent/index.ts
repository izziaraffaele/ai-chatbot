 ...
 * - Memory configured with LibSQL for conversation history and persistent working memory
 * - Working memory tracks user preferences, active planning context, and communication style across threads
 * - Resource-scoped memory persists user information across all conversations
